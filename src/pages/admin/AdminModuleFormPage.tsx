  ...
  return (
    <main className="admin-page">
      <PageHeader
        ...
        description="Form sahələri backend DTO-lara uyğun ayrılıb; save əməliyyatı sonra API service-ə bağlanacaq."
      />
      <form className="form-layout">
        ...
        <aside className="form-side">
          <section className="form-card">
            ...
            <p>Contract Active deyilsə public booking/order/payment bağlı qalır. Cash payment UI və API səviyyəsində qəbul edilmir.</p>
          </section>
