    ...
    <main className="page">
      ...
      <section className="menu-layout">
        <div className="menu-main">
          <PageHeader title="Öncədən sifariş" description="Kateqoriyaya uyğun item-ləri seç. MVP-də əsas dine-in order waiter tərəfindən bağlanır." />
        ...
        <aside className="order-summary">
          ...
          <p className="online-only">Ödəniş: yalnız online/system-tracked. Cash MVP-də deaktivdir.</p>
