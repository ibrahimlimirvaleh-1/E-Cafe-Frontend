...
export const staff: StaffMember[] = [
  { id: 'staff-leyla', restaurantId: 'saffron-premium', name: 'Leyla Məmmədova', role: 'Waiter', phone: '+994 50 777 11 22', status: 'Active', serviceFeePercent: 12, currentEarning: 146, avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=300&q=80' },
  { id: 'staff-ali', restaurantId: 'saffron-premium', name: 'Əli Həsənov', role: 'Waiter', phone: '+994 55 345 88 91', status: 'OnBreak', currentEarning: 92, avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=300&q=80' },
  { id: 'staff-nigar', restaurantId: 'saffron-premium', name: 'Nigar Əliyeva', role: 'Manager', phone: '+994 70 333 44 55', status: 'Active', currentEarning: 0, avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=300&q=80' },
  { id: 'staff-kitchen', restaurantId: 'saffron-premium', name: 'Kitchen Board', role: 'Kitchen', phone: '-', status: 'Active', currentEarning: 0, avatar: 'https://images.unsplash.com/photo-1577219491135-ce391730fb2c?auto=format&fit=crop&w=300&q=80' },
]
