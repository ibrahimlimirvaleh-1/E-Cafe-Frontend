...
function translateErrorCode(code: string) {
  ...
  const messages: Record<string, string> = {
    ...
    InvalidItemId: 'Menyu elementi seçimi düzgün deyil.',
    InvalidRestaurantId: 'Restoran seçimi düzgün deyil.',
    InvalidRoleId: 'Rol seçimi düzgün deyil.',
    ItemAlreadyExistsInCategory: 'Bu kateqoriyada eyni adlı menyu elementi artıq mövcuddur.',
    ItemNotFound: 'Menyu elementi tapılmadı. Siyahını yeniləyib yenidən yoxlayın.',
